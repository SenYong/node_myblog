            ...
            <div class="l_box f_l">
                 <div class="topnews">
                    ...
                    <div class="artContent">
                        ...
                        <p class="box">发布时间：{{timestampToTime(artData.a_time)}}<span>编辑：{{artData.a_root}}</span>阅读（{{artData.a_hit}}）</p>
                        <div class="info" v-html="artData.a_content"></div>
                    </div>
                    <div class="copyright_author">
                        <p>
                          <strong>版权声明：</strong>
                          本站原创文章，于{{timestampToTime(artData.a_time)}}，由
                          <a href="https://www.fishblog.top" target="_blank">{{artData.a_root}}</a>
                          发表
                        </p>
                        <p class="p-hidden">
                          <strong>转载请注明：</strong>
                          <a href="https://www.fishblog.top" target="_self">{{artData.a_name}}</a>
                           | 
                            ...
                            <div class="lItem">
                                 ...
                                 <div class="lCont">
                                    <p class="p1">
                                      ...
                                      <span class="s2">{{timestampToTime(item.ac_time)}}</span>
                                    </p>
                            ...
                            <div class="lItem rItem" v-if="item.ac_retime">
                               ...
                               <div class="lCont">
                                  <p class="p1">
                                    ...
                                    <span class="s2">{{timestampToTime(item.ac_retime)}}</span>
                                  </p>
...
<script type="text/javascript">
    import { getArtDetail, userComment, getArtComment } from '@/api/article'
        ...
        methods: {
            ...
            submit(){
              ...
              userComment(ac_pid, ac_name, ac_img, ac_content).then(res => {
                  res.code == 0 ? this.getUserComment(ac_pid) : this.$message.error(res.msg);
                  this.ac_content = ''
